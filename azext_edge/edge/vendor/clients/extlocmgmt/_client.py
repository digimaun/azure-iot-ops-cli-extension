...
class CustomLocations:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype custom_locations: extloc.mgmt.operations.CustomLocationsOperations
    :ivar resource_sync_rules: ResourceSyncRulesOperations operations
    :vartype resource_sync_rules: extloc.mgmt.operations.ResourceSyncRulesOperations
