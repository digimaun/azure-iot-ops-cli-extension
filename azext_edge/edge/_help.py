...
def load_iotops_help():
    ...
    helps[
        ...
        - name: To configure component features such as preview settings, use the --feature option.
          text: >
              az iot ops create --cluster mycluster -g myresourcegroup --name myinstance --sr-resource-id $SCHEMA_REGISTRY_RESOURCE_ID
              --feature mqttBroker.settings.previewConfig=Enabled
    """
    ...
    helps[
        ...
        - name: Update instance component features such as preview settings.
          text: >
            az iot ops update --name myinstance -g myresourcegroup --feature mqttBroker.settings.previewConfig=Enabled
    """
